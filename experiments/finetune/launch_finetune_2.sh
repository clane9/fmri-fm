...
# repr="patch"
# clf="attn"
ckpt_path="experiments/model_scaling/output/model_scaling/d6/pretrain/checkpoint-last.pth"
repr=cls
clf=linear
...
name="${EXP_NAME}/d6_${key}_lr${lr}/${dataset}__${repr}__${clf}"
...
overrides="model_kwargs.ckpt_path=${ckpt_path} lr=${lr} wandb=false batch_size=128 accum_iter=1"
