...
configs=(
    T64_pt16_1/patch/attn
    T64_pt16_2/patch/attn
    T64_pt16_3/patch/attn
    T64_pt16_4/patch/attn
    T16_pt16_1/patch/attn
    T16_pt16_2/patch/attn
)
...
notes="long sequence ablation $key; eval v2 (${dataset} ${repr} ${clf})"
